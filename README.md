# Clinivore — Psychiatric Treatment Continuity Dashboard

> **Phase 1 MVP** — A staff-facing workflow system for behavioral health practices managing recurring psychiatric treatments.

## What Is Clinivore?

Clinivore helps psychiatric practice staff answer one daily question:
...
Clinivore ships with a mock AI mode (no API key needed). For real drafts:
...
- Push chart notes generated by Clinivore directly to the patient chart
...
*Clinivore Phase 1 MVP — Built for psychiatric behavioral health practices.*
